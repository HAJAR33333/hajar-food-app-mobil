    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.statusCard}>
          <View style={styles.statusRow}>
            ...
            <Text style={styles.statusText}>
              {isSimulator ? t('notifications.simulator') : t('notifications.physical_device')}
            </Text>
          </View>
          <View style={styles.statusRow}>
            <Ionicons
            ...
            />
            <Text style={styles.statusText}>
              {hasPermission ? t('notifications.permissions_granted') : t('notifications.permissions_denied')}
            </Text>
          </View>
          {pushToken && (
          ...
          <View style={styles.badgeContainer}>
            <Text style={styles.badgeLabel}>{t('notifications.badge_count')}: {badgeCount}</Text>
          </View>
          {/* {scheduled.length > 0 && (
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>{t('notifications.actions')}</Text>
          ...
          >
            ...
            <Text style={styles.buttonText}>{t('notifications.init')}</Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={styles.buttonText}>{t('notifications.send_immediate')}</Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={styles.buttonText}>{t('notifications.schedule_5s')}</Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={styles.buttonText}>{t('notifications.schedule_30s')}</Text>
          </TouchableOpacity>
          ...
          <View style={styles.buttonRow}>
            ...
            >
              ...
              <Text style={styles.buttonTextSmall}>{t('notifications.set_badge')}</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text style={styles.buttonTextSmall}>{t('notifications.clear_badge')}</Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>{t('notifications.test_results')}</Text>
          ...
          {testResults.length === 0 ? (
            <View style={styles.emptyResults}>
              ...
              <Text style={styles.emptyText}>{t('notifications.no_results')}</Text>
              <Text style={styles.emptySubtext}>
                {t('notifications.no_results_sub')}
              </Text>
            </View>
          ) : (
        ...
        {isSimulator && (
          <View style={styles.infoBox}>
            ...
            <Text style={styles.infoText}>
              {t('notifications.simulator_warning')}
            </Text>
          </View>
        )}
      </ScrollView>
